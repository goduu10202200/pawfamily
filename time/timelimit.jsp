...
<html class="no-js" lang="zh-tw ">
	<head>
		...
		<link href="../css/timelimit.css" rel="stylesheet">
	...
	<body>
		...
		<section class="timelimit">
			<div class="time-wrap">
				<div class="time-title">
					<h2>限時優惠</h2>
					<p class="desc">5/14 - 6/17</p>
				</div>
				<div class="time-box">
					<div class="time-boxCont">
						<p class="box-title">
							<span>全館滿699享8折優惠</span>
						</p>
						<img src="../img/latest/l_n31.jpg" >
						
					</div>
					<div class="time_text">
						<p>【活動日期】<br>
						2017.5.14(六)PM 12:00~2017.6.17(六)PM 11:59</p>
						<br>
						<p>【注意事項】<br>
							...
							5.如遇商品缺貨導致無法出貨,Paw Family保有取消訂單的權利
						</p>
						<br>
						<p>
							【貼心小提醒】<br>
							1.下單後將於3個工作天內出貨<br>
							3.訂單一旦取消就無法恢復，如仍需商品請重新訂購<br>
							2.限時優惠商品數量有限，售完不補！依完成訂購者為優先
						</p>
					</div>
				</div>
			</div>
