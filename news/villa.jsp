			...
			<div id="news_villa">
				<div class="news_view">
					...
					<div class="news_text">
						...
						<div class="text">
							<p>經由杉木打造而成的寵物木屋，具備冬暖夏涼的特性，讓毛小孩彷彿坐擁大自然<br>
								森林之中，吸收天然的芬多精氣息，表面經由防水漆處理，亦可置於室外使用。<br>
								雙層透天豪宅式設計，讓毛小孩們可以慵懶的在上層享受日光浴，貓咪們也可在<br>
								這盡情玩樂上下的跳動玩耍。
							</p>
						</div>
					</div>
					<div class="news_img">
						<img src="../img/slides/v1_n.jpg">
					</div>
					<div class="news_text">
						<div class="title2">
							<p>商品規格</p>
