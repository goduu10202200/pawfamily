	...
	<body>
		<div id="main">
			...
			<section class="ln1">
				...
				<div class="ln1_text">
				<div class="ln1_img">
				<img src="../img/latest/l_n1.jpg" style="width:500px;height:480px;">
				</div>
				<p>
					事事無法預料，再乖的寵物難保哪天會突然暴走，或是不小心走失而讓你措手不及。<br>
					這時候如果你早已幫牠準備了"寵物名牌"，那麼相信一定能夠幫助你順利找到!!!<br>
					客製化專屬寵物吊牌是你最好的選擇，全新推出迷你場記板，每隻毛寵物都應該擁有！<br>
					
				</p>
				<div class="ln1_img">
				<img src="../img/latest/l_n1-2.jpg" style="width:520px;height:260px;">
				</div>
				<div>
				<p>	顏色:黑<br>
					材質:純手工壓克力打磨製作<br>
					尺寸:41X40mm 厚度:4mm 雙鐵圈尺寸:直徑20mm<br>
					※此商品為"可動"設計，請勿打開過大角度，避免斷裂。
				</p>
				</div>
