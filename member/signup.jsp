				...
				<div id="signup">
					<div class="signup_container">
						<form name="user" method="POST" action="account.jsp">
							...
							<label for="fname"><font color="#FFFFFF" size="5" >ACCOUNT</label></font><br>
							<input type="text" id="account" name="id" value=""><br>
							<label for="fname"><font color="#FFFFFF" size="5" >PASSWORD</label></font><br>
							<input type="text" id="password" name="pwd" value="" ><br>
							
							<label for="fname"><font color="#FFFFFF" size="5">NAME</label></font><br>
							<input type="text" id="name" name="name" value="" ><br>
							
							<label for="lname"><font color="#FFFFFF" size="5">E-MAIL</label></font><br>
							<input type="text" id="email" name="mail" value=""><br>
							
							<label for="lname"><font color="#FFFFFF" size="5">PHONE</label></font><br>
							<input type="text" id="phone" name="phone" value=""><br>
							
							<label for="lname"><font color="#FFFFFF" size="5">ADDRESS</label></font><br>
							<input type="text" id="address" name="address" value=""><br>
						</form>
							<input type="submit" onclick="datacheck(this.form)" value="Sign up" id="button">
					</div>
				</div>
			</div>
		</section>
