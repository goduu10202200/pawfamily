...
//Step 3: 選擇資料庫   
			...
			while(rs.next())
				{
				if( delete_id.equals(rs.getString(3))) 
					product_delete = rs.getString("product_id");
					sql = "delete from shoppingcar where product_id='"+product_delete+"'";
...
//Step 5: 顯示結果 
          //直接顯示最新的資料
		  response.sendRedirect("../shoppingcar/shoppingcar_order.jsp");
