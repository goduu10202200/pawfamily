			...
			<div class="product">
				...
				<div class="product_info">
					...
					out.println("連線建立失敗");
						...
						sql="select * from paw_goods AS t1 where t1.class_id='C2' OR t1.class_id='C3'";
						...
						//out.println("<font face='Microsoft JhengHei' size='4'>共"+total_content+"筆留言<p>");
							...
							//遞減排序, 讓最新的資料排在最前面
							sql="select * from paw_goods AS t1 where t1.class_id='C2' OR t1.class_id='C3'  ORDER BY t1.class_id DESC LIMIT ";
							...
							out.println("<div class='right_page' style='color: #000;'>");
								...
								{
								out.print("<a href='home.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
								}
							out.println("</div>");
							//Step 6: 關閉連線
							con.close();
