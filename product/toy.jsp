								...
								<li class="pawnav">
									...
									<ul class="subNav">
										...
										<li>
											...
											<a href="javascript: return false" onclick="toy_class('C2');"> 寵物窩</a>
											<a href="javascript: return false" onclick="toy_class('C3');">床墊</a>
										</li>
										<li>
		...
		<section>
			<div class="product">
				<div class="product_title_picture">
					<img src="../img/product_title/D13(1).jpg">
					<span class="product_title">寵物玩具</span>
				</div>
				<div class="product_titlebar">
					<div class="titlebar_left">
						<span>首頁/商品專區/寵物玩具</span>
					</div>
				...
				<div class="product_info">
					<div class="info_left">
						<h3 style="font-size:28px;">寵物玩具</h3>
						<ul class="list">
							<li>
								<a href="javascript: return false" onclick="toy_class('C4');"> 組合屋</a>
							</li>
					...
					out.println("連線建立失敗");
						...
						sql="select * from paw_goods AS t1 where t1.class_id='C4' OR t1.class_id='C5'";
						...
						//out.println("<font face='Microsoft JhengHei' size='4'>共"+total_content+"筆留言<p>");
							...
							//遞減排序, 讓最新的資料排在最前面
							sql="select * from paw_goods AS t1 where t1.class_id='C4' OR t1.class_id='C5' ORDER BY t1.class_id DESC LIMIT ";
									...
									out.println("<ul>");
										out.println("<li>");
											out.println("<span class='right_picture'>");
												out.println("<img src='../img/product/toy/"+rs.getString("product_id")+"_2.jpg'>");
											out.println("</span>");
							...
							out.println("<div class='right_page' style='color: #000;'>");
								...
								{
								out.print("<a href='toy.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
								}
							out.println("</div>");
							//Step 6: 關閉連線
							con.close();
