...
int left;
String leftString;
sql="SELECT product_id,class_id,product_name,product_price,product_stock FROM paw_goods WHERE product_name='西莎餐盒牛肉 100g'";
			...
			<section>
				<div class="product_content">
					<div class="product_bar">
						<span>首頁/商品專區/食物/西莎餐盒牛肉 100g </span>
					</div>
						...
						<div class="product_top_left">
								...
								<ul role="tablist">
									<li class="active">
										<a href="#1" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/food/12_1.jpg" >
										</a>
									</li>
								</ul>
							</div>
							<div class="product_img tab-content">
								<div role="tabpanel" class="tab-pane active" id="1">
									<img src="../img/product/food/12_2.jpg">
								</div>
							</div>
						</div>
					    ...
					    <div role="tabpanel" class="tab-pane active" id="home"> 
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
					    			...
					    			<ul>
					    				<p>
										西莎牛肉罐頭。是狗狗最喜愛的狗用餐盒，推出全新西莎保養系列，幫助強化免疫力，優質成分更添寵物活力，澳洲進口上等鮮牛肉，不只美味，天加大量維生素、礦物質、蔬菜，給寶貝狗狗最健康的餐盒。					
										</p>
									</ul>
								</div>
					    	</div>
