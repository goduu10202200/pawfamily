...
int left;
String leftString;
sql="SELECT product_id,class_id,product_name,product_price,product_stock FROM paw_goods WHERE product_name='鄉村木別墅'";
						...
						<div class="product_top_left">
								...
								<ul role="tablist">
									<li class="active">
										<a href="#1" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/31_1.jpg" >
										</a>
									</li>
									<li>
										<a href="#2" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/31_1-2.jpg">
										</a>
									</li>								
								</ul>
							</div>
							<div class="product_img tab-content">
								<div role="tabpanel" class="tab-pane active" id="1">
									<img src="../img/product/home/31_2.jpg">
								</div>
								<div role="tabpanel" class="tab-pane" id="2">
									<img src="../img/product/home/31_2-2.jpg">
								</div>
							</div>
						</div>
					    ...
					    <div role="tabpanel" class="tab-pane active" id="home"> 
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
					    			...
					    			<ul>
					    				<p>
										在喧鬧城市中，擁有著輕步調生活是一種幸福。動物緣鄉村木別墅，採用杉木材質無毒無害，讓毛小孩享受良好住宿環境。雙層透天豪宅式設計，讓毛小孩們可以慵懶的在上層享受日光浴，貓咪們也可在這盡情玩樂上下的跳動玩耍。	
										</p>
									</ul>
								</div>
					    	</div>
