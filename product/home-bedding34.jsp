...
int left;
String leftString;
sql="SELECT product_id,class_id,product_name,product_price,product_stock FROM paw_goods WHERE product_name='Stripe Yellow寵物手工帳篷'";
			...
			<section>
				<div class="product_content">
					<div class="product_bar">
						<span>首頁/商品專區/食物/Stripe Yellow寵物手工帳篷</span>
					</div>
						...
						<div class="product_top_left">
								...
								<ul role="tablist">
									<li class="active">
										<a href="#1" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/34_1.jpg" >
										</a>
									</li>
									<li>
										<a href="#2" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/34_1-2.jpg">
										</a>
									</li>
								</ul>
							</div>
							<div class="product_img tab-content">
								<div role="tabpanel" class="tab-pane active" id="1">
									<img src="../img/product/home/34_2.jpg">
								</div>
								<div role="tabpanel" class="tab-pane" id="2">
									<img src="../img/product/home/34_2-2.jpg">
								</div>															
							</div>
						</div>
						<div class="product_top_right">
							...
							<div class="right_product_introduction">
								<ul class="introduction_text">
									<li>使用由來自新西蘭的松木及牛津棉布製成</li>
									<li>通風良好，組裝與拆卸都毫不費力</li>
								</ul>
							</div>
					    ...
					    <div role="tabpanel" class="tab-pane active" id="home"> 
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
					    			...
					    			<ul>
					    				<p>
										由來自新西蘭的松木及牛津棉布製成，牛津棉布這種材料厚實及具有韌性，能確保布料反复洗滌後依舊能保持布料的圖形。帳棚式設計使小屋通風良好，組裝與拆卸都毫不費力，簡單地連接線到頂點，再將坐墊放入，可水洗又好收納不占空間。
										</p>
									</ul>
								</div>
					    	</div>
