...
int left;
String leftString;
sql="SELECT product_id,class_id,product_name,product_price,product_stock FROM paw_goods WHERE product_name='西莎餐盒野菜牛肉 100g'";
			...
			<section>
				<div class="product_content">
					<div class="product_bar">
						<span>首頁/商品專區/食物/西莎餐盒野菜牛肉 100g</span>
					</div>
						...
						<div class="product_top_left">
								...
								<ul role="tablist">
									<li class="active">
										<a href="#1" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/food/13_1.jpg" >
										</a>
									</li>
								</ul>
							</div>
							<div class="product_img tab-content">
								<div role="tabpanel" class="tab-pane active" id="1">
									<img src="../img/product/food/13_2.jpg">
								</div>
							</div>
						</div>
						<div class="product_top_right">
							...
							<div class="right_product_introduction">
								<ul class="introduction_text">
									<li>嚴選澳洲優質鮮肉營養完整均衡</li>
									<li>嚴選蔬果食材，更具均衡營養概念</li>
								</ul>
							</div>
					    ...
					    <div role="tabpanel" class="tab-pane active" id="home"> 
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
					    			...
					    			<ul>
					    				<p>
										西莎野菜牛肉罐頭。是狗狗最喜愛的狗用餐盒，推出全新西莎保養系列，幫助強化免疫力，優質成分更添寵物活力，澳洲進口上等鮮牛肉，不只美味，天加大量維生素、礦物質、蔬菜，給寶貝狗狗最健康的餐盒。							
										</p>
									</ul>
								</div>
					    	</div>
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
					    			<h4>【商品成分】</h4>
					    				<p>
					    				肉類(牛肉等)、蔬菜(胡蘿蔔/青豆/黃椒)、糙米、纖維、大蒜粉、金盞菊研磨粉、紫花苜蓿萃取物、蕃茄粉、維生素群(B1/B6/C/E/泛酸)、礦物質(鈣/氯/銅/碘/鉀/錳/鋅)、牛磷酸
								</div>		
							</div>		
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
