				...
				<div class="product_info">
					<div class="info_left">
						...
						<ul class="list">
							...
							<li>
								<a href="javascript: return false" onclick="food_dessert();" style="font-size:20px; font-weight:bold;">點心</a>
								<ul class="b">
									<li>
										<a href="javascript: return false" onclick="logo('日本MU');">日本MU</a>
										<a href="javascript: return false" onclick="logo('活力零食');">活力零食</a>
					...
					out.println("連線建立失敗");
						...
						sql="select * from paw_goods AS t1 where t1.class_id='C1'";
						...
						//out.println("<font face='Microsoft JhengHei' size='4'>共"+total_content+"筆留言<p>");
							...
							//遞減排序, 讓最新的資料排在最前面
							sql="select * from paw_goods AS t1 where t1.class_id='C1' ORDER BY t1.class_id DESC LIMIT ";
							...
							out.println("<div class='right_page' style='color: #000;'>");
								...
								{
								out.print("<a href='food_desert.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
								}
							out.println("</div>");
							//Step 6: 關閉連線
							con.close();
