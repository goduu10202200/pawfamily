								...
								<li class="pawnav">
									...
									<ul class="subNav">
										...
										<li>
											...
											<a href="javascript: return false" onclick="customized_logo('項圈');">項圈</a>
											<a href="javascript: return false" onclick="customized_logo('吊牌');">吊牌</a>
											<a href="javascript: return false" onclick="customized_logo('領巾');">領巾</a>
											<a href="javascript: return false" onclick="customized_class2();" class="toptitle2" style="font-size:20px; font-weight:bold;">小物</a>
											<a href="javascript: return false" onclick="customized_logo('牽繩');">牽繩</a>
											<a href="javascript: return false" onclick="customized_logo('蝴蝶結');">蝴蝶結</a>
											<a href="javascript: return false" onclick="customized_logo('寵物包');">寵物包</a>
		...
		<section>
			<div class="product">
				<div class="product_title_picture">
					<img src="../img/product_title/E18(3)2.jpg">
					<span class="product_title" >客製化</span>
				</div>
				<div class="product_titlebar">
					<div class="titlebar_left">
						<span>首頁/商品專區/客製化</span>
					</div>
				...
				<div class="product_info">
					<div class="info_left">
						<h3 style="font-size:28px;">客製化</h3>
						<ul class="list">
							<li>
								<a href="javascript: return false" onclick="customized_class();" style="font-size:20px; font-weight:bold;">項圈吊牌</a>
								<ul class="b">
							...
							<li>
								<a href="javascript: return false" onclick="customized_class2();" style="font-size:20px; font-weight:bold;">小物</a>
								<ul class="b">
									<li>
										<a  href="javascript: return false" onclick="customized_logo('D6');">牽繩</a>
									</li>
									<li>
										<a  href="javascript: return false" onclick="customized_logo('D7');">蝴蝶結</a>
									</li>
									<li>
					...
					out.println("連線建立失敗");
						...
						sql="use pawfamily";
						con.createStatement().execute(sql);
						String toy_class= request.getParameter("toy_class");
						...
						sql="select * from paw_goods AS t1 where t1.class_id='D3' OR t1.class_id='D4' OR t1.class_id='D5' OR t1.class_id='D6' OR t1.class_id='D7' OR t1.class_id='D8'";
						...
						//out.println("<font face='Microsoft JhengHei' size='4'>共"+total_content+"筆留言<p>");
							...
							//遞減排序, 讓最新的資料排在最前面
							sql="select * from paw_goods AS t1 where t1.class_id='D3' OR t1.class_id='D4' OR t1.class_id='D5' OR t1.class_id='D6' OR t1.class_id='D7' OR t1.class_id='D8' ORDER BY t1.class_id DESC LIMIT ";
									...
									out.println("<ul>");
										out.println("<li>");
											out.println("<span class='right_picture'>");
												out.println("<img src='../img/product/customized/"+rs.getString("product_id")+"_2.jpg'>");
											out.println("</span>");
											out.println("<span class='right_product'>");
												out.println("<a href=''>"+rs.getString("product_name")+"</a>");
											out.println("</span>");
											out.println("<span class='right_price'>");
												out.println("<a href=''>$"+rs.getString("product_price")+"</a>");
											out.println("</span>");
										out.println("</li>");
									out.println("</ul>");
									}
							...
							out.println("<div class='right_page' style='color: #000;'>");
								...
								{
								out.print("<a href='customized.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
								}
							out.println("</div>");
							//Step 6: 關閉連線
							con.close();
