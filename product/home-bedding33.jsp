...
int left;
String leftString;
sql="SELECT product_id,class_id,product_name,product_price,product_stock FROM paw_goods WHERE product_name='Diamond鑽石型寵物窩'";
			...
			<section>
				<div class="product_content">
					<div class="product_bar">
						<span>首頁/商品專區/食物/Diamond鑽石型寵物窩</span>
					</div>
						...
						<div class="product_top_left">
								...
								<ul role="tablist">
									<li class="active">
										<a href="#1" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/33_1.jpg" >
										</a>
									</li>
									<li>
										<a href="#2" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/33_1-2.jpg">
										</a>
									</li>
								</ul>
							</div>
							<div class="product_img tab-content">
								<div role="tabpanel" class="tab-pane active" id="1">
									<img src="../img/product/home/33_2.jpg">
								</div>
								<div role="tabpanel" class="tab-pane" id="2">
									<img src="../img/product/home/33_2-2.jpg">
								</div>															
							</div>
						</div>
						<div class="product_top_right">
							...
							<div class="right_product_introduction">
								<ul class="introduction_text">
									<li>100％的乙烯基塗層瓦楞紙生態板製成</li>
									<li>內部採波紋狀構造，相當穩定及安全</li>
								</ul>
							</div>
					    ...
					    <div role="tabpanel" class="tab-pane active" id="home"> 
					    	<div class="food_earthborn">
					    		<div class="food_earthborntext">
					    			...
					    			<ul>
					    				<p>
										鑽石是由100％的乙烯基塗層瓦楞紙生態板製作而成，能夠承受高度的重量，其內部是波紋狀構造。相當穩定及安全，無論是組裝或拆卸都非常簡單，讓您的毛孩子能有個舒適的環境。外觀是大理石圖形設計，讓它不只是寵物屋，更能成為居家裝飾品。
										</p>
									</ul>
								</div>
					    	</div>
