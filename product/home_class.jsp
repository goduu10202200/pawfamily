		...
		<section>
			<div class="product">
				<div class="product_title_picture">
					<img src="../img/product_title/D31(2).jpg">
					<span class="product_title">寵物窩</span>
				</div>
				<div class="product_titlebar">
					<div class="titlebar_left">
						<span>首頁/商品專區/寵物窩</span>
					</div>
				...
				<div class="product_info">
					<div class="info_left">
						<h3 style="font-size:28px;">寵物窩</h3>
						<ul class="list">
							<li>
								<a href="javascript: return false" onclick="home_class('C2');"> 寵物窩</a>
							</li>
					...
					out.println("連線建立失敗");
						...
						sql="use pawfamily";
						con.createStatement().execute(sql);
						String home_class= request.getParameter("home_class");
						...
						sql="select * from paw_goods AS t1 where t1.class_id='"+home_class+"'";
						...
						//out.println("<font face='Microsoft JhengHei' size='4'>共"+total_content+"筆留言<p>");
							...
							//遞減排序, 讓最新的資料排在最前面
							sql="select * from paw_goods AS t1 where t1.class_id='"+home_class+"' ORDER BY t1.class_id DESC LIMIT ";
									...
									out.println("<ul>");
										out.println("<li>");
											out.println("<span class='right_picture'>");
												out.println("<img src='../img/product/home/"+rs.getString("product_id")+"_2.jpg'>");
											out.println("</span>");
											out.println("<span class='right_product'>");
												out.println("<a href='home-bedding"+rs.getString("product_id")+".jsp'>"+rs.getString("product_name")+"</a>");
											out.println("</span>");
											out.println("<span class='right_price'>");
												out.println("<a href='home-bedding"+rs.getString("product_id")+".jsp'>$"+rs.getString("product_price")+"</a>");
											out.println("</span>");
										out.println("</li>");
									out.println("</ul>");
									}
							...
							%>
							<%
							//String home_class2=rs2.getString("class_id");
							rs2.last();
							int total_content2=rs2.getRow();  //先移到檔尾, getRow()後, 就可知道共有幾筆記錄
							//每頁顯示9筆, 算出共幾頁
							...
							out.println("<div class='right_page' style='color: #000;'>");
								...
								{
								//out.print("<a href='home_class.jsp?home_class="+home_class+"'>"+i+"</a>&nbsp;");
								out.print("<a href='home_class.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
								}
							out.println("</div>");
							//Step 6: 關閉連線
							con.close();
