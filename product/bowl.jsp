		...
		<section>
			<div class="product">
				<div class="product_title_picture">
					<img src="../img/product_title/E19(1)2.jpg">
					<span class="product_title">寵物碗具</span>
				</div>
				<div class="product_titlebar">
					<div class="titlebar_left">
						<span>首頁/商品專區/寵物碗具</span>
					</div>
				...
				<div class="product_info">
					<div class="info_left">
						<h3 style="font-size:28px;">寵物碗具</h3>
						<ul class="list">
							<li>
								<a href="javascript: return false" onclick="bowl_class('C6');"> 碗架</a>
							</li>
							<li>
								<a href="javascript: return false" onclick="bowl_class('C7');">寵物碗 </a>
							</li>
						</ul>
					</div>
					<%
					...
					out.println("連線建立失敗");
						...
						sql="select * from paw_goods AS t1 where t1.class_id='C6' OR t1.class_id='C7'";
						...
						//out.println("<font face='Microsoft JhengHei' size='4'>共"+total_content+"筆留言<p>");
							...
							//遞減排序, 讓最新的資料排在最前面
							sql="select * from paw_goods AS t1 where t1.class_id='C6' OR t1.class_id='C7' ORDER BY t1.class_id DESC LIMIT ";
									...
									out.println("<ul>");
										out.println("<li>");
											out.println("<span class='right_picture'>");
												out.println("<img src='../img/product/bowl/"+rs.getString("product_id")+"_2.jpg'>");
											out.println("</span>");
							...
							out.println("<div class='right_page' style='color: #000;'>");
								...
								{
								out.print("<a href='bowl.jsp?page="+i+"'>"+i+"</a>&nbsp;"); //&nbsp;html的空白
								}
							out.println("</div>");
							//Step 6: 關閉連線
							con.close();
