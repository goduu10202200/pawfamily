...
int left;
String leftString;
sql="SELECT product_id,class_id,product_name,product_price,product_stock FROM paw_goods WHERE product_name='綠色幾何圖寵物窩'";
						...
						<div class="product_top_left">
								...
								<ul role="tablist">
									<li class="active">
										<a href="#1" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/36_1.jpg" >
										</a>
									</li>
									<li>
										<a href="#2" aria-controls="home" role="tab" data-toggle="tab">
											<img src="../img/product/home/36_1-2.jpg">
										</a>
									</li>
								</ul>
							</div>
							<div class="product_img tab-content">
								<div role="tabpanel" class="tab-pane active" id="1">
									<img src="../img/product/home/36_2.jpg">
								</div>
								<div role="tabpanel" class="tab-pane" id="2">
									<img src="../img/product/home/36_2-2.jpg">
								</div>															
							</div>
						</div>
