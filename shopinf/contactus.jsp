		...
		<div id="main">
			...
			<div id="terms">
				<div class="terms_view">
					<div class="terms">
			 			<div class="terms_title">聯絡我們</div>
			 				<div class="terms_line" ></div>
			 					<div class="contactus">
			 					<img src="../img/shopinf/contact.jpg">
			 					<p>
			 					Paw Family寵物用品專賣<br>
								網路客戶服務專線：(03)4577-7777<br>
								服務時間：週一～週五 9:00-12:30 / 13:30-18:00<br>
								客服信箱：pawfamily@gmail.com<br>
								服務地址：320桃園市中壢區中北路200號<br>
								</p>
			 					</div>
			 		</div>
			 	</div>
