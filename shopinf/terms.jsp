	...
	<body>
		<div id="main">
			...
			<div class="terms_view">
			 <div class="terms">
			 	<div class="terms_title">聲明條款</div>
			 	<div class="terms_line" ></div>
			 		<div class="terms_text">
			 		<h4>隱私權聲明</h4>
					 <p>
					 以下是Paw Family關於線上隱私權的政策，使用者如果對於Paw Family隱私權政策或與個人資料有關之相關事項有任何疑問，可以利用電子郵件我們連絡，將會盡快為您回覆說明。<br></p>

					<h5>一、個人資料取得</h5><br>
					使用者進入Paw Family相關網站時，Paw Family會紀錄使用者上站的位址，以及在Paw Family相關網站內的瀏覽活動等資料，但上述資料僅供作流量分析和網路行為調查，以便於改善Paw Family相關網站的服務品質，上述資料亦僅作為總量上之分析，不會和特定個人相連繫。

					<h5>二、個人資料的利用</h5><br>
					Paw Family相關網站所取得之個人資料，僅供Paw Family於其內部、依照原來說明的使用目的和範圍加以使用，除非事先說明或依照相關法律規定，否則Paw Family不會將使用者個人資料提供給第三人或移作其他目的使用。

					<h5>三. 資料安全</h5><br>
					Paw Family將盡力以合理之技術及程序，保障所有個人資料之安全。


					<h5>四. 本隱私權政策的變更</h5><br>
					本隱私權政策會不時變更，但Paw Family不會在未經使用者同意的情況下，削減本隱私權政策賦予使用者的權利，若有所變更，大多為小幅修正，Paw Family會將隱私權政策之所有變更張貼於此網頁上，本隱私權政策的每個版本皆會顯示生效日期，如果有任何關於本隱私權政策的問題或疑慮，歡迎隨時與我們連絡。

					<h4>著作權聲明</h4>
					本網站上的任何圖片及資料皆為學術上使用，若有侵權，尚請見諒並請來信告知移除侵權內容。
