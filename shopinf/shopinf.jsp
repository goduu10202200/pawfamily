		...
		<div id="main">
			...
			<div id="terms">
				<div class="terms_view">
					<div class="terms">
			 			<div class="terms_title">購物資訊</div>
			 				<div class="terms_line" ></div>
			 					<div class="terms_text">
			 					 Paw Family提供簡單又安全的購物流程，即可開始選購您喜愛的商品。<br>
			 					 <br>
			 						 <img src="../img/shopinf/shopinf.jpg">
			 							 <ul style="list-style-type: disc;">
			 								<li>提醒您，商品加入購物車但未結帳前，並無保留商品庫存功能，商品庫存分配將以結帳順序為依據。<br></li>
											<li>台灣外島地區目前開放便利達康取貨服務(僅限全家便利商店、萊爾富、OK便利商店)，7-11門市取<br>
											貨以及黑貓宅急便(含刷卡、貨到付款)尚未提供，不便之處敬請見諒。<br></li>
											<li>本網站所有計價單位皆為「新台幣 TWD(NT$)」。<br></li> 
										</ul>


										<h5>退換貨服務</h5>
										<p>
										消費者可依照消費者保護法的規定，享有商品貨到日起七天猶豫期的權益，建議您收到商品立即開箱確認，並於七日內提出退換貨申請。提醒您「猶豫期並非試用期」，所以您所退回的商品必須是全新的狀態、而且完整包裝；請注意保持商品本體、配件、贈品、保證書、原廠包裝及所有附隨文件或資料的完整性，切勿缺漏任 何配件或損毀原廠外盒，並由您支付商品寄出運費+退貨寄回運費，即可退貨退款。食品類、接觸性商品、低溫配送類商品恕不在此規範內。
										</p>
