	...
	<a href="manager_center.jsp"><input type="button" class="button alt" value="返回選擇列"></a><p>
			...
			<%
				...
				//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
						 sql="select * from paw_goods AS t1 where t1.class_id='D3' OR t1.class_id='D4' OR t1.class_id='D5' OR t1.class_id='D6' OR t1.class_id='D7' OR t1.class_id='D8'"; //算出共幾筆留言
