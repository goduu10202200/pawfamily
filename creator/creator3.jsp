			...
			<div id="creator">
				<div class="creator_view">
					...
					<div class="section3">
						...
						<h4>Paralife</h4>
						<p class="p">
							我們的產品以天然、環保的物料為主，絕不使用動物皮作材料。強烈質感，配<br>
							合簡單樸素的設計，捨棄不必要的裝飾，便能突出非常漂亮的天然物料。我們<br>
							相信不同植物原材料有著獨突、不可取代之美。懂得欣賞它，便能感受大自奧<br>
							妙之處。除了主打的天然物料，我們主張循環再造的環保物料，包括報紙、再<br>
							造紙等，經加工後，讓物件擁有第二次的生命。我們相信環保是一種個人生活<br>
							的態度，把它貫徹於產品之中，讓更多人共同珍惜資源。
						</p>
					</div>
