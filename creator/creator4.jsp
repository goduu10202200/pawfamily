			...
			<div id="creator">
				<div class="creator_view">
					...
					<div class="section3">
						...
						<h4>sienna</h4>
						<p class="p">
							品牌創始於2005年，以皮件為原點，慢慢的延展出除了皮件以外，讓生活更便<br>
							利的設計產品。台灣少量生產，品質和實用性是我們最在意的。關於皮革創作<br>
							在自己生活中的位置；皮革創作從一開始單純興趣的好奇、摸索、沉迷到變成<br>
							工作、生活技能、飯碗，期間也經歷過為了生活沒天沒夜製作趕工；然而現在<br>
							希望慢慢能回歸到初見面的原點。
						</p>
					</div>
